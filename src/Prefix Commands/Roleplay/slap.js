module.exports = {
  ...
  usage: "slap <user>",
  category: "Roleplay",
  source: "https://github.com/Kiko-Labs/Kiko-San/blob/stable/src/Prefix%20Commands/Roleplay/slap.js",
  type: "messageCreate",
  code: `
    $start
    $onlyIf[$httpRequest[https://purrbot.site/api/list/sfw/hit/gif;GET]==200;
      $title[Error]
